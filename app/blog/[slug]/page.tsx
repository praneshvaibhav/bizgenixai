...
export default async function InsightPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <div className={styles.page} id="top"><a className={styles.skipLink} href="#main-content">Skip to content</a><Navigation activePath="/blog" /><main id="main-content">
    ...
    <section id="contact" className={styles.previewContact}><div className={styles.container}><h2>Have a use case in mind?</h2><Link className={styles.primary} href={contactUrl}>Talk to our team →</Link></div></section>
